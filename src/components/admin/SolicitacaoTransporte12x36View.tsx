...
import { SolicitacaoTransporte12x36 } from "@/types/solicitacoes";
import { Textarea } from "@/components/ui/textarea";
import { Label } from "@/components/ui/label";
import { AdminCommentField } from "./AdminCommentField";

interface SolicitacaoTransporte12x36ViewProps {
  solicitacao: SolicitacaoTransporte12x36;
  onStatusChange: () => void;
}

export function SolicitacaoTransporte12x36View({ 
  solicitacao, 
  onStatusChange 
}: SolicitacaoTransporte12x36ViewProps) {
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p>{new Date(solicitacao.data_inicio).toLocaleDateString()}</p>
          </div>
        </div>
