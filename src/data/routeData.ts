...
// Adding data for other turnos (2° Turno, 3° Turno, Administrativo)
// Example data for now - to be replaced with actual data
const segundoTurnoRoutes: RouteData = {
  "S-01": [
    { lat: -16.328118, lng: -48.953529, nome: "S-01 01 - Exemplo ponto 2° Turno", bairro: "Centro", semana: "12:10", sabado: "12:10" },
    { lat: -16.407132, lng: -48.918605, nome: "S-01 Final - Distrito Agroindustrial de Anápolis", bairro: "Laboratório Teuto", semana: "13:00", sabado: "13:00" },
  ],
  // Add more routes for 2° Turno when available
};
